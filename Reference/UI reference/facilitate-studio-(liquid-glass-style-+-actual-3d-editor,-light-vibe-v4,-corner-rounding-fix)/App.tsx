...
function App() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black selection:bg-blue-500/30 selection:text-white">
      ...
      {/* Floating UI Layer */}
      {/* Note: Components inside here must have pointer-events-auto if this container has pointer-events-none */}
