...
export const INITIAL_STEPS: SimStep[] = [
  {
    ...
    description: 'Locate and verify power supply.',
    completed: true,
  },
  {
    id: 'step-2',
    title: 'Safety Check',
    description: 'Ensure all safety barriers are in place.',
    completed: false,
  },
  {
    id: 'step-3',
    title: 'Activate Pump',
    description: 'Turn on the main industrial pump.',
    completed: false,
  },
  {
    id: 'step-4',
    title: 'Monitor Pressure',
    description: 'Wait for pressure to stabilize.',
    completed: false,
  },
];
